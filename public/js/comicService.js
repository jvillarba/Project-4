(function(){
  ...
  function comicService($http) {
    ...
    function index(){
      ...
      return $http.get('http://gateway.marvel.com/v1/public/series?contains=comic&orderBy=title&limit=100&apikey=5e45799598348828dc44c8d57a384063&ts=6000000&hash=3ee98aaa969afe79643eb22a155ec6ef')
    }
    ...
    function show(id){
      ...
      return $http.get('http://gateway.marvel.com:80/v1/public/series/18454/comics?formatType=comic&noVariants=false&hasDigitalIssue=true&orderBy=title&apikey=5e45799598348828dc44c8d57a384063&ts=6000000&hash=3ee98aaa969afe79643eb22a155ec6ef')
    }
  }
})()
